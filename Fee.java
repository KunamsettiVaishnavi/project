...
//	@Column(name = "FeeId")
	...
	@Min(value = 0, message = "Cost cannot be less than 1000")
	@ApiModelProperty(name = "totalFeesDue",value = "Holds total fee due")
	private double totalFeesDue;
	
	@Min(value = 0, message = "Fee cannot be less than 1000")
	...
	//totalFeesDue = totalFees - feeInstallmentamt

//	@OneToOne(cascade = CascadeType.ALL)
	//@ElementCollection
	//@JoinColumn(name = "feeinstallment", referencedColumnName = "feeInstallmentId")
